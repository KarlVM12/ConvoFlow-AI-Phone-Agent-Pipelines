...
$connectorName = 'Restaurant'; // Ex: 'Dialogflow_CX_Test1'
...
echo $voiceResponse; // A successful response connect the Twilio agent to the user who called based on the connector name
